          ...
          <?php while ($pecah = mysqli_fetch_assoc($ambil)) { ?>
            <form action="" method="post" enctype="multipart/form-data">
              ...
              <div class="p-3 p-lg-4 border">
                ...
                <div class="form-group row">
                  <div class="col-md-12 mb-3">
                    <label for="Nama_Rek" class="text-black mb-1">Nama Rekening yang Melakukan Pembayaran<span class="text-danger">*</span></label>
                ...
                <div class="form-group row">
                  <div class="col-md-12 mb-3">
                    ...
                    <div class="col-md-12"> <input name="Total_Order" type="text" class="form-control" id="Total_Order" value="<?php echo 'Rp. ' . number_format($pecah['Total_pesanan'] + $pecah['ID_Pesanan'] + $pecah['Ongkir'], 2, ',', '.'); ?>" readonly></div>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-12 mb-3">
