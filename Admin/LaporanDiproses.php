...
<head>
   ...
   <main id="main" class="main">
      <div class="pagetitle">
         <h1>Laporan Pesanan Diproses</h1>
         <nav>
            <ol class="breadcrumb">
               <li class="breadcrumb-item"><a href="Dashboard.php">Home</a></li>
               <li class="breadcrumb-item active">Laporan Pesanan Diproses</li>
            </ol>
         </nav>
      </div>
      <?php $i = 1; ?>
      <section class="section">
         <div class="row">
            <div class="col-lg-12">
               <div class="card">
                  <div class="card-body">
                     <a class="btn btn-primary col-2 mt-3" href="LaporanExcelDiProses.php" target="_blank" alt="Edit Data"> <i class="ri-download-2-fill"></i> Download Excel</a>
