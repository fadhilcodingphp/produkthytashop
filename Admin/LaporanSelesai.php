      ...
      <div class="pagetitle">
         ...
         <nav>
            <ol class="breadcrumb">
               ...
               <li class="breadcrumb-item active">Laporan Pesanan Selesai</li>
            </ol>
         </nav>
      </div>
      <?php $i = 1; ?>
      <section class="section">
         <div class="row">
            <div class="col-lg-12">
               <div class="card">
                  <div class="card-body">
                     <a class="btn btn-primary col-2 mt-3" href="LaporanExcelSelesai.php" target="_blank" alt="Edit Data"> <i class="ri-download-2-fill"></i> Download Excel</a>
