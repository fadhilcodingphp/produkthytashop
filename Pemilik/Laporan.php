                  ...
                  <div class="card-body">
                     ...
                     <form action="" method="post" name="laporan">
                        <div class="row">
                           ...
                           <div class="col-lg-4">
                              <b>Status :</b>
                              <a class="btn btn-primary" href="LaporanDiproses.php">Diproses</a>
                              <a class="btn btn-primary" href="LaporanDikirim.php">Dikirim</a>
                              <a class="btn btn-primary" href="LaporanSelesai.php">Selesai</a>
                           </div>
                        </div>
                  </div>
                  </form>
                  <a class="btn btn-primary col-2" style="margin-left: 20px;" href="LaporanExcel.php?sqlPeriode=<?= $sqlPeriode; ?>" target="_blank" alt="Edit Data"> <i class="ri-download-2-fill"></i> Download Excel</a>
